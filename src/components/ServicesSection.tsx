...
const ServicesSection = () => {
  return <section id="servicios" className="py-20 bg-digital-light">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Nuestros Servicios</h2>
          <div className="w-24 h-1 bg-digital-gold mx-auto mb-6"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">protegemos lo que mas valoras con servicios integrales en seguridad digital , accesos inteligentes y cerraduras electrónicas </p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => <Card key={index} className="border border-gray-200 hover:border-digital-gold transition-all duration-300 hover:shadow-lg">
              <CardHeader>

...
const Navbar = () => {
  ...
  return <nav className="bg-digital-black sticky top-0 z-50">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <a href="/" className="flex items-center">
              <img src="/lovable-uploads/226b30b8-7ecb-4d24-ab19-fb909908968d.png" alt="Digital Doors Logo" className="h-12 mr-3" />
            </a>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative">
              <Button variant="ghost" className="text-digital-gold hover:bg-digital-gray" onClick={() => navigate('/carrito')}>
                <ShoppingCart className="h-6 w-6" />
                {itemCount > 0 && <span className="absolute -top-2 -right-2 bg-red-500 text-white rounded-full text-xs w-5 h-5 flex items-center justify-center">
                    {itemCount}
                  </span>}
              </Button>
            </div>
          ...
          <div className="md:hidden flex items-center">
            ...
            <Button variant="ghost" className="text-digital-gold hover:bg-digital-gray" onClick={() => setIsMenuOpen(!isMenuOpen)}>

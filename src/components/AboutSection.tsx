...
const AboutSection = () => {
  return (
    <section id="nosotros" className="py-20 bg-digital-black">
        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-300 mb-6">
              En Digital Doors Service Center somos especialistas en soluciones de acceso digital y seguridad para hogares y negocios. Contamos con más de 10 años de experiencia en el sector.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <div className="bg-digital-gray bg-opacity-50 p-4 rounded-lg">
                <div className="text-digital-gold text-3xl font-bold mb-2">10+</div>
                <div className="text-white">Años de experiencia</div>
              </div>
              <div className="bg-digital-gray bg-opacity-50 p-4 rounded-lg">
                <div className="text-digital-gold text-3xl font-bold mb-2">500+</div>
                <div className="text-white">Clientes satisfechos</div>
              </div>
              <div className="bg-digital-gray bg-opacity-50 p-4 rounded-lg">
                <div className="text-digital-gold text-3xl font-bold mb-2">24/7</div>
                <div className="text-white">Servicio de emergencia</div>
              </div>
              <div className="bg-digital-gray bg-opacity-50 p-4 rounded-lg">
